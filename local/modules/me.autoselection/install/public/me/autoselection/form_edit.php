...
if (!Loader::includeModule('me.autoselection') || !$USER->isAdmin() || !Loader::includeModule('iblock'))
    return;
...
while ($property = $properties->Fetch()) {
    $PROPS [] = ['ID' => $property['ID'], 'CODE' => $property['CODE'], 'NAME' => $property['NAME']];
}
$hlBlockId = \Me\Autoselection\Helpers\HighloadBlock::getHlBlockId(['NAME' => 'MeAutoSelectionBrands']);
